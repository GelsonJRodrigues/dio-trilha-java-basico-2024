...
import java.util.Scanner; //implementa operações de entrada de dados pelo teclado
import java.util.Locale; //considera as representações regionais do alfabeto, símbolos, números e datas
import java.text.NumberFormat; //formata números conforme a localização geográfica
